...
class Another_Window(QWidget):
    ...
    def func_handleButtonClicked(self):
        ...
        if totem == True:
            self.neweditInput = resize_wood(list_withdraw_resize, self.str_date, self.type_resize, wood_quantity)
            self.close()
...
class resize_wood (QWidget):
    ...
    def display(self):
        ...
        #                        " Wide: "+self.wood_wide+" Long: "+self.wood_long+
        #                        " Wood type: "+self.wood_type+" Quantity: "+str(self.wood_quantity))
    ...
    def displayTable(self):
        ...
        self.table_resize .setColumnCount(7)
    ...
    def funcShowdata(self):
        ...
        for row_data in query:
            ...
            for column_number, data in enumerate(row_data):
                self.table_resize .setItem(row_number, column_number, QTableWidgetItem(str(data)))
